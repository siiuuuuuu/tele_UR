...
TIMESTAMP_INT_KEYS = (
    ...
    "t_front_camera_receive_host_ns",
    "front_camera_frame_global_mono_ns",
    "front_camera_seq",
    "front_camera_frame_no",
    "t_wrist_camera_host_ns",
    "t_wrist_camera_receive_host_ns",
    "wrist_camera_frame_global_mono_ns",
    "wrist_camera_seq",
...
TIMESTAMP_FLOAT_KEYS = (
    "interpolation_alpha",
    "front_camera_dev_ts",
    "front_camera_sensor_timestamp_us",
    "front_camera_timestamp_fit_residual_ms",
    "front_camera_receive_minus_image_ms",
    "wrist_camera_dev_ts",
    "wrist_camera_sensor_timestamp_us",
    "wrist_camera_timestamp_fit_residual_ms",
    "wrist_camera_receive_minus_image_ms",
